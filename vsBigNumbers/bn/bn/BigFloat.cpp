...
*/
	...
	for (size_t i = 1; curSubtrahend <= subtotal || i < 4; ++i) // ВРЕМЕННАЯ МЕРА ТОЛЬКО ДЛЯ ТЕСТОВ!!!!!!!!!!!!!!!
	{
		/**/
		// #nxtdigqnt 5
		std::cout
	...
	const
{
	...
	for (size_t i = 1; subtotal < divisorInt || i < 4; ++i) // ВРЕМЕННАЯ МЕРА ТОЛЬКО ДЛЯ ТЕСТОВ!!!!!!!!!!!!!!!
	{
		/**/
		// #calcsubdig 1
		std::cout
...
/**/
		...
		for // ВРЕМЕННАЯ МЕРА ТОЛЬКО ДЛЯ ТЕСТОВ!!!!!!!!!!!!!!!
			(	
				size_t i = 0;
